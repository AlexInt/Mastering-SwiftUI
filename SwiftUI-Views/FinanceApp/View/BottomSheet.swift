...
struct BottomSheet<Content>: View where Content: View  {
    ...
    @GestureState private var dragState = PFDragState.inactive
    ...
    var body: some View {
        GeometryReader { geometry in
            VStack {
                ...
                ScrollView(.vertical) {
                    ...
                    GeometryReader { scrollViewProxy in
                        Color.clear.preference(key: PFScrollOffsetKey.self, value: scrollViewProxy.frame(in: .named("scrollview")).minY)
                    }
                    .frame(height: 0)
            ...
            .onPreferenceChange(PFScrollOffsetKey.self) { value in
...
struct PFScrollOffsetKey: PreferenceKey {
