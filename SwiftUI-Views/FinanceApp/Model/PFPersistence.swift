...
struct PFPersistenceController {
    static let shared = PFPersistenceController()

    let container: NSPersistentContainer

    static var preview: PFPersistenceController = {
        let result = PFPersistenceController(inMemory: true)
